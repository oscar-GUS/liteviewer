 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,P){var T=N.length;N.push(P);e:for(;0<T;){var Z=T-1>>>1,Y=N[Z];if(0<r(Y,P))N[Z]=P,N[T]=Y,T=Z;else break e}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var P=N[0],T=N.pop();if(T!==P){N[0]=T;e:for(var Z=0,Y=N.length,ne=Y>>>1;Z<ne;){var K=2*(Z+1)-1,te=N[K],G=K+1,W=N[G];if(0>r(te,T))G<Y&&0>r(W,te)?(N[Z]=W,N[G]=T,Z=G):(N[Z]=te,N[K]=T,Z=K);else if(G<Y&&0>r(W,T))N[Z]=W,N[G]=T,Z=G;else break e}}return P}function r(N,P){var T=N.sortIndex-P.sortIndex;return T!==0?T:N.id-P.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],h=1,d=null,u=3,p=!1,_=!1,x=!1,g=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(N){for(var P=n(c);P!==null;){if(P.callback===null)i(c);else if(P.startTime<=N)i(c),P.sortIndex=P.expirationTime,e(l,P);else break;P=n(c)}}function S(N){if(x=!1,v(N),!_)if(n(l)!==null)_=!0,V(b);else{var P=n(c);P!==null&&L(S,P.startTime-N)}}function b(N,P){_=!1,x&&(x=!1,f(y),y=-1),p=!0;var T=u;try{for(v(P),d=n(l);d!==null&&(!(d.expirationTime>P)||N&&!D());){var Z=d.callback;if(typeof Z=="function"){d.callback=null,u=d.priorityLevel;var Y=Z(d.expirationTime<=P);P=t.unstable_now(),typeof Y=="function"?d.callback=Y:d===n(l)&&i(l),v(P)}else i(l);d=n(l)}if(d!==null)var ne=!0;else{var K=n(c);K!==null&&L(S,K.startTime-P),ne=!1}return ne}finally{d=null,u=T,p=!1}}var w=!1,R=null,y=-1,C=5,U=-1;function D(){return!(t.unstable_now()-U<C)}function z(){if(R!==null){var N=t.unstable_now();U=N;var P=!0;try{P=R(!0,N)}finally{P?B():(w=!1,R=null)}}else w=!1}var B;if(typeof m=="function")B=function(){m(z)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,k=X.port2;X.port1.onmessage=z,B=function(){k.postMessage(null)}}else B=function(){g(z,0)};function V(N){R=N,w||(w=!0,B())}function L(N,P){y=g(function(){N(t.unstable_now())},P)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,V(b))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):C=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return u},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(N){switch(u){case 1:case 2:case 3:var P=3;break;default:P=u}var T=u;u=P;try{return N()}finally{u=T}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,P){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var T=u;u=N;try{return P()}finally{u=T}},t.unstable_scheduleCallback=function(N,P,T){var Z=t.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?Z+T:Z):T=Z,N){case 1:var Y=-1;break;case 2:Y=250;break;case 5:Y=1073741823;break;case 4:Y=1e4;break;default:Y=5e3}return Y=T+Y,N={id:h++,callback:P,priorityLevel:N,startTime:T,expirationTime:Y,sortIndex:-1},T>Z?(N.sortIndex=T,e(c,N),n(l)===null&&N===n(c)&&(x?(f(y),y=-1):x=!0,L(S,T-Z))):(N.sortIndex=Y,e(l,N),_||p||(_=!0,V(b))),N},t.unstable_shouldYield=D,t.unstable_wrapCallback=function(N){var P=u;return function(){var T=u;u=P;try{return N.apply(this,arguments)}finally{u=T}}}})(X0);j0.exports=X0;var R1=j0.exports;/**
 * @license React
...
`)+`
`+f);const v=m+g+o,S=m+f+a,b=i0(r,r.VERTEX_SHADER,v),w=i0(r,r.FRAGMENT_SHADER,S);r.attachShader(x,b),r.attachShader(x,w),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function R(D){if(t.debug.checkShaderErrors){const z=r.getProgramInfoLog(x)||"",B=r.getShaderInfoLog(b)||"",X=r.getShaderInfoLog(w)||"",k=z.trim(),V=B.trim(),L=X.trim();let N=!0,P=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(N=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,b,w);else{const T=s0(r,b,"vertex"),Z=s0(r,w,"fragment");lt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
Program Info Log: `+k+`
`+T+`
`+Z)}else k!==""?je("WebGLProgram: Program Info Log:",k):(V===""||L==="")&&(P=!1);P&&(D.diagnostics={runnable:N,programLog:k,vertexShader:{log:V,prefix:g},fragmentShader:{log:L,prefix:f}})}r.deleteShader(b),r.deleteShader(w),y=new ql(r,x),C=JA(r,x)}let y;this.getUniforms=function(){return y===void 0&&R(this),y};let C;this.getAttributes=function(){return C===void 0&&R(this),C};let U=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return U===!1&&(U=r.getProgramParameter(x,GA)),U},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(x),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=WA++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=b,this.fragmentShader=w,this}let m2=0;class g2{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new _2(e),n.set(e,i)),i}}class _2{constructor(e){this.id=m2++,this.code=e,this.usedTimes=0}}function v2(t){return t===Qr||t===yc||t===Sc}function x2(t,e,n,i,r,s){const o=new vp,a=new g2,l=new Set,c=[],h=new Map,d=i.logarithmicDepthBuffer;let u=i.precision;const p={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(y){return l.add(y),y===0?"uv":`uv${y}`}function x(y,C,U,D,z,B){const X=D.fog,k=z.geometry,V=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?D.environment:null,L=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap,N=e.get(y.envMap||V,L),P=N&&N.mapping===jc?N.image.height:null,T=p[y.type];y.precision!==null&&(u=i.getMaxPrecision(y.precision),u!==y.precision&&je("WebGLProgram.getParameters:",y.precision,"not supported, using",u,"instead."));const Z=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,Y=Z!==void 0?Z.length:0;let ne=0;k.morphAttributes.position!==void 0&&(ne=1),k.morphAttributes.normal!==void 0&&(ne=2),k.morphAttributes.color!==void 0&&(ne=3);let K,te,G,W;if(T){const Ye=_i[T];K=Ye.vertexShader,te=Ye.fragmentShader}else K=y.vertexShader,te=y.fragmentShader,a.update(y),G=a.getVertexShaderID(y),W=a.getFragmentShaderID(y);const q=t.getRenderTarget(),se=t.state.buffers.depth.getReversed(),ue=z.isInstancedMesh===!0,de=z.isBatchedMesh===!0,Re=!!y.map,xe=!!y.matcap,Ve=!!N,Fe=!!y.aoMap,Ae=!!y.lightMap,ie=!!y.bumpMap,ce=!!y.normalMap,Ee=!!y.displacementMap,I=!!y.emissiveMap,ye=!!y.metalnessMap,Xe=!!y.roughnessMap,st=y.anisotropy>0,ge=y.clearcoat>0,ot=y.dispersion>0,A=y.iridescence>0,M=y.sheen>0,$=y.transmission>0,ae=st&&!!y.anisotropyMap,he=ge&&!!y.clearcoatMap,me=ge&&!!y.clearcoatNormalMap,we=ge&&!!y.clearcoatRoughnessMap,re=A&&!!y.iridescenceMap,le=A&&!!y.iridescenceThicknessMap,Pe=M&&!!y.sheenColorMap,Ne=M&&!!y.sheenRoughnessMap,Se=!!y.specularMap,_e=!!y.specularColorMap,qe=!!y.specularIntensityMap,Ze=$&&!!y.transmissionMap,dt=$&&!!y.thicknessMap,H=!!y.gradientMap,ve=!!y.alphaMap,oe=y.alphaTest>0,Le=!!y.alphaHash,Me=!!y.extensions;let fe=Ei;y.toneMapped&&(q===null||q.isXRRenderTarget===!0)&&(fe=t.toneMapping);const Oe={shaderID:T,shaderType:y.type,shaderName:y.name,vertexShader:K,fragmentShader:te,defines:y.defines,customVertexShaderID:G,customFragmentShaderID:W,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:u,batching:de,batchingColor:de&&z._colorsTexture!==null,instancing:ue,instancingColor:ue&&z.instanceColor!==null,instancingMorph:ue&&z.morphTexture!==null,outputColorSpace:q===null?t.outputColorSpace:q.isXRRenderTarget===!0?q.texture.colorSpace:rt.workingColorSpace,alphaToCoverage:!!y.alphaToCoverage,map:Re,matcap:xe,envMap:Ve,envMapMode:Ve&&N.mapping,envMapCubeUVHeight:P,aoMap:Fe,lightMap:Ae,bumpMap:ie,normalMap:ce,displacementMap:Ee,emissiveMap:I,normalMapObjectSpace:ce&&y.normalMapType===NM,normalMapTangentSpace:ce&&y.normalMapType===rf,packedNormalMap:ce&&y.normalMapType===rf&&v2(y.normalMap.format),metalnessMap:ye,roughnessMap:Xe,anisotropy:st,anisotropyMap:ae,clearcoat:ge,clearcoatMap:he,clearcoatNormalMap:me,clearcoatRoughnessMap:we,dispersion:ot,iridescence:A,iridescenceMap:re,iridescenceThicknessMap:le,sheen:M,sheenColorMap:Pe,sheenRoughnessMap:Ne,specularMap:Se,specularColorMap:_e,specularIntensityMap:qe,transmission:$,transmissionMap:Ze,thicknessMap:dt,gradientMap:H,opaque:y.transparent===!1&&y.blending===Gs&&y.alphaToCoverage===!1,alphaMap:ve,alphaTest:oe,alphaHash:Le,combine:y.combine,mapUv:Re&&_(y.map.channel),aoMapUv:Fe&&_(y.aoMap.channel),lightMapUv:Ae&&_(y.lightMap.channel),bumpMapUv:ie&&_(y.bumpMap.channel),normalMapUv:ce&&_(y.normalMap.channel),displacementMapUv:Ee&&_(y.displacementMap.channel),emissiveMapUv:I&&_(y.emissiveMap.channel),metalnessMapUv:ye&&_(y.metalnessMap.channel),roughnessMapUv:Xe&&_(y.roughnessMap.channel),anisotropyMapUv:ae&&_(y.anisotropyMap.channel),clearcoatMapUv:he&&_(y.clearcoatMap.channel),clearcoatNormalMapUv:me&&_(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:we&&_(y.clearcoatRoughnessMap.channel),iridescenceMapUv:re&&_(y.iridescenceMap.channel),iridescenceThicknessMapUv:le&&_(y.iridescenceThicknessMap.channel),sheenColorMapUv:Pe&&_(y.sheenColorMap.channel),sheenRoughnessMapUv:Ne&&_(y.sheenRoughnessMap.channel),specularMapUv:Se&&_(y.specularMap.channel),specularColorMapUv:_e&&_(y.specularColorMap.channel),specularIntensityMapUv:qe&&_(y.specularIntensityMap.channel),transmissionMapUv:Ze&&_(y.transmissionMap.channel),thicknessMapUv:dt&&_(y.thicknessMap.channel),alphaMapUv:ve&&_(y.alphaMap.channel),vertexTangents:!!k.attributes.tangent&&(ce||st),vertexNormals:!!k.attributes.normal,vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,pointsUvs:z.isPoints===!0&&!!k.attributes.uv&&(Re||ve),fog:!!X,useFog:y.fog===!0,fogExp2:!!X&&X.isFogExp2,flatShading:y.wireframe===!1&&(y.flatShading===!0||k.attributes.normal===void 0&&ce===!1&&(y.isMeshLambertMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isMeshPhysicalMaterial)),sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:se,skinning:z.isSkinnedMesh===!0,morphTargets:k.morphAttributes.position!==void 0,morphNormals:k.morphAttributes.normal!==void 0,morphColors:k.morphAttributes.color!==void 0,morphTargetsCount:Y,morphTextureStride:ne,numDirLights:C.directional.length,numPointLights:C.point.length,numSpotLights:C.spot.length,numSpotLightMaps:C.spotLightMap.length,numRectAreaLights:C.rectArea.length,numHemiLights:C.hemi.length,numDirLightShadows:C.directionalShadowMap.length,numPointLightShadows:C.pointShadowMap.length,numSpotLightShadows:C.spotShadowMap.length,numSpotLightShadowsWithMaps:C.numSpotLightShadowsWithMaps,numLightProbes:C.numLightProbes,numLightProbeGrids:B.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:y.dithering,shadowMapEnabled:t.shadowMap.enabled&&U.length>0,shadowMapType:t.shadowMap.type,toneMapping:fe,decodeVideoTexture:Re&&y.map.isVideoTexture===!0&&rt.getTransfer(y.map.colorSpace)===pt,decodeVideoTextureEmissive:I&&y.emissiveMap.isVideoTexture===!0&&rt.getTransfer(y.emissiveMap.colorSpace)===pt,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===un,flipSided:y.side===Cn,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionClipCullDistance:Me&&y.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Me&&y.extensions.multiDraw===!0||de)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()};return Oe.vertexUv1s=l.has(1),Oe.vertexUv2s=l.has(2),Oe.vertexUv3s=l.has(3),l.clear(),Oe}function g(y){const C=[];if(y.shaderID?C.push(y.shaderID):(C.push(y.customVertexShaderID),C.push(y.customFragmentShaderID)),y.defines!==void 0)for(const U in y.defines)C.push(U),C.push(y.defines[U]);return y.isRawShaderMaterial===!1&&(f(C,y),m(C,y),C.push(t.outputColorSpace)),C.push(y.customProgramCacheKey),C.join()}function f(y,C){y.push(C.precision),y.push(C.outputColorSpace),y.push(C.envMapMode),y.push(C.envMapCubeUVHeight),y.push(C.mapUv),y.push(C.alphaMapUv),y.push(C.lightMapUv),y.push(C.aoMapUv),y.push(C.bumpMapUv),y.push(C.normalMapUv),y.push(C.displacementMapUv),y.push(C.emissiveMapUv),y.push(C.metalnessMapUv),y.push(C.roughnessMapUv),y.push(C.anisotropyMapUv),y.push(C.clearcoatMapUv),y.push(C.clearcoatNormalMapUv),y.push(C.clearcoatRoughnessMapUv),y.push(C.iridescenceMapUv),y.push(C.iridescenceThicknessMapUv),y.push(C.sheenColorMapUv),y.push(C.sheenRoughnessMapUv),y.push(C.specularMapUv),y.push(C.specularColorMapUv),y.push(C.specularIntensityMapUv),y.push(C.transmissionMapUv),y.push(C.thicknessMapUv),y.push(C.combine),y.push(C.fogExp2),y.push(C.sizeAttenuation),y.push(C.morphTargetsCount),y.push(C.morphAttributeCount),y.push(C.numDirLights),y.push(C.numPointLights),y.push(C.numSpotLights),y.push(C.numSpotLightMaps),y.push(C.numHemiLights),y.push(C.numRectAreaLights),y.push(C.numDirLightShadows),y.push(C.numPointLightShadows),y.push(C.numSpotLightShadows),y.push(C.numSpotLightShadowsWithMaps),y.push(C.numLightProbes),y.push(C.shadowMapType),y.push(C.toneMapping),y.push(C.numClippingPlanes),y.push(C.numClipIntersection),y.push(C.depthPacking)}function m(y,C){o.disableAll(),C.instancing&&o.enable(0),C.instancingColor&&o.enable(1),C.instancingMorph&&o.enable(2),C.matcap&&o.enable(3),C.envMap&&o.enable(4),C.normalMapObjectSpace&&o.enable(5),C.normalMapTangentSpace&&o.enable(6),C.clearcoat&&o.enable(7),C.iridescence&&o.enable(8),C.alphaTest&&o.enable(9),C.vertexColors&&o.enable(10),C.vertexAlphas&&o.enable(11),C.vertexUv1s&&o.enable(12),C.vertexUv2s&&o.enable(13),C.vertexUv3s&&o.enable(14),C.vertexTangents&&o.enable(15),C.anisotropy&&o.enable(16),C.alphaHash&&o.enable(17),C.batching&&o.enable(18),C.dispersion&&o.enable(19),C.batchingColor&&o.enable(20),C.gradientMap&&o.enable(21),C.packedNormalMap&&o.enable(22),C.vertexNormals&&o.enable(23),y.push(o.mask),o.disableAll(),C.fog&&o.enable(0),C.useFog&&o.enable(1),C.flatShading&&o.enable(2),C.logarithmicDepthBuffer&&o.enable(3),C.reversedDepthBuffer&&o.enable(4),C.skinning&&o.enable(5),C.morphTargets&&o.enable(6),C.morphNormals&&o.enable(7),C.morphColors&&o.enable(8),C.premultipliedAlpha&&o.enable(9),C.shadowMapEnabled&&o.enable(10),C.doubleSided&&o.enable(11),C.flipSided&&o.enable(12),C.useDepthPacking&&o.enable(13),C.dithering&&o.enable(14),C.transmission&&o.enable(15),C.sheen&&o.enable(16),C.opaque&&o.enable(17),C.pointsUvs&&o.enable(18),C.decodeVideoTexture&&o.enable(19),C.decodeVideoTextureEmissive&&o.enable(20),C.alphaToCoverage&&o.enable(21),C.numLightProbeGrids>0&&o.enable(22),y.push(o.mask)}function v(y){const C=p[y.type];let U;if(C){const D=_i[C];U=bc.clone(D.uniforms)}else U=y.uniforms;return U}function S(y,C){let U=h.get(C);return U!==void 0?++U.usedTimes:(U=new p2(t,C,y,r),c.push(U),h.set(C,U)),U}function b(y){if(--y.usedTimes===0){const C=c.indexOf(y);c[C]=c[c.length-1],c.pop(),h.delete(y.cacheKey),y.destroy()}}function w(y){a.remove(y)}function R(){a.dispose()}return{getParameters:x,getProgramCacheKey:g,getUniforms:v,acquireProgram:S,releaseProgram:b,releaseShaderCache:w,programs:c,dispose:R}}function y2(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function S2(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.materialVariant!==e.materialVariant?t.materialVariant-e.materialVariant:t.z!==e.z?t.z-e.z:t.id-e.id}function u0(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function h0(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(u){let p=0;return u.isInstancedMesh&&(p+=2),u.isSkinnedMesh&&(p+=1),p}function a(u,p,_,x,g,f){let m=t[e];return m===void 0?(m={id:u.id,object:u,geometry:p,material:_,materialVariant:o(u),groupOrder:x,renderOrder:u.renderOrder,z:g,group:f},t[e]=m):(m.id=u.id,m.object=u,m.geometry=p,m.material=_,m.materialVariant=o(u),m.groupOrder=x,m.renderOrder=u.renderOrder,m.z=g,m.group=f),e++,m}function l(u,p,_,x,g,f){const m=a(u,p,_,x,g,f);_.transmission>0?i.push(m):_.transparent===!0?r.push(m):n.push(m)}function c(u,p,_,x,g,f){const m=a(u,p,_,x,g,f);_.transmission>0?i.unshift(m):_.transparent===!0?r.unshift(m):n.unshift(m)}function h(u,p){n.length>1&&n.sort(u||S2),i.length>1&&i.sort(p||u0),r.length>1&&r.sort(p||u0)}function d(){for(let u=e,p=t.length;u<p;u++){const _=t[u];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:l,unshift:c,finish:d,sort:h}}function M2(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new h0,t.set(i,[o])):r>=s.length?(o=new h0,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function w2(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new O,color:new Qe};break;case"SpotLight":n={position:new O,direction:new O,color:new Qe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new O,color:new Qe,distance:0,decay:0};break;case"HemisphereLight":n={direction:new O,skyColor:new Qe,groundColor:new Qe};break;case"RectAreaLight":n={color:new Qe,position:new O,halfWidth:new O,halfHeight:new O};break}return t[e.id]=n,n}}}function E2(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let b2=0;function T2(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function A2(t){const e=new w2,n=E2(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new O);const r=new O,s=new He,o=new He;function a(c){let h=0,d=0,u=0;for(let C=0;C<9;C++)i.probe[C].set(0,0,0);let p=0,_=0,x=0,g=0,f=0,m=0,v=0,S=0,b=0,w=0,R=0;c.sort(T2);for(let C=0,U=c.length;C<U;C++){const D=c[C],z=D.color,B=D.intensity,X=D.distance;let k=null;if(D.shadow&&D.shadow.map&&(D.shadow.map.texture.format===Qr?k=D.shadow.map.texture:k=D.shadow.map.depthTexture||D.shadow.map.texture),D.isAmbientLight)h+=z.r*B,d+=z.g*B,u+=z.b*B;else if(D.isLightProbe){for(let V=0;V<9;V++)i.probe[V].addScaledVector(D.sh.coefficients[V],B);R++}else if(D.isDirectionalLight){const V=e.get(D);if(V.color.copy(D.color).multiplyScalar(D.intensity),D.castShadow){const L=D.shadow,N=n.get(D);N.shadowIntensity=L.intensity,N.shadowBias=L.bias,N.shadowNormalBias=L.normalBias,N.shadowRadius=L.radius,N.shadowMapSize=L.mapSize,i.directionalShadow[p]=N,i.directionalShadowMap[p]=k,i.directionalShadowMatrix[p]=D.shadow.matrix,m++}i.directional[p]=V,p++}else if(D.isSpotLight){const V=e.get(D);V.position.setFromMatrixPosition(D.matrixWorld),V.color.copy(z).multiplyScalar(B),V.distance=X,V.coneCos=Math.cos(D.angle),V.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),V.decay=D.decay,i.spot[x]=V;const L=D.shadow;if(D.map&&(i.spotLightMap[b]=D.map,b++,L.updateMatrices(D),D.castShadow&&w++),i.spotLightMatrix[x]=L.matrix,D.castShadow){const N=n.get(D);N.shadowIntensity=L.intensity,N.shadowBias=L.bias,N.shadowNormalBias=L.normalBias,N.shadowRadius=L.radius,N.shadowMapSize=L.mapSize,i.spotShadow[x]=N,i.spotShadowMap[x]=k,S++}x++}else if(D.isRectAreaLight){const V=e.get(D);V.color.copy(z).multiplyScalar(B),V.halfWidth.set(D.width*.5,0,0),V.halfHeight.set(0,D.height*.5,0),i.rectArea[g]=V,g++}else if(D.isPointLight){const V=e.get(D);if(V.color.copy(D.color).multiplyScalar(D.intensity),V.distance=D.distance,V.decay=D.decay,D.castShadow){const L=D.shadow,N=n.get(D);N.shadowIntensity=L.intensity,N.shadowBias=L.bias,N.shadowNormalBias=L.normalBias,N.shadowRadius=L.radius,N.shadowMapSize=L.mapSize,N.shadowCameraNear=L.camera.near,N.shadowCameraFar=L.camera.far,i.pointShadow[_]=N,i.pointShadowMap[_]=k,i.pointShadowMatrix[_]=D.shadow.matrix,v++}i.point[_]=V,_++}else if(D.isHemisphereLight){const V=e.get(D);V.skyColor.copy(D.color).multiplyScalar(B),V.groundColor.copy(D.groundColor).multiplyScalar(B),i.hemi[f]=V,f++}}g>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=be.LTC_FLOAT_1,i.rectAreaLTC2=be.LTC_FLOAT_2):(i.rectAreaLTC1=be.LTC_HALF_1,i.rectAreaLTC2=be.LTC_HALF_2)),i.ambient[0]=h,i.ambient[1]=d,i.ambient[2]=u;const y=i.hash;(y.directionalLength!==p||y.pointLength!==_||y.spotLength!==x||y.rectAreaLength!==g||y.hemiLength!==f||y.numDirectionalShadows!==m||y.numPointShadows!==v||y.numSpotShadows!==S||y.numSpotMaps!==b||y.numLightProbes!==R)&&(i.directional.length=p,i.spot.length=x,i.rectArea.length=g,i.point.length=_,i.hemi.length=f,i.directionalShadow.length=m,i.directionalShadowMap.length=m,i.pointShadow.length=v,i.pointShadowMap.length=v,i.spotShadow.length=S,i.spotShadowMap.length=S,i.directionalShadowMatrix.length=m,i.pointShadowMatrix.length=v,i.spotLightMatrix.length=S+b-w,i.spotLightMap.length=b,i.numSpotLightShadowsWithMaps=w,i.numLightProbes=R,y.directionalLength=p,y.pointLength=_,y.spotLength=x,y.rectAreaLength=g,y.hemiLength=f,y.numDirectionalShadows=m,y.numPointShadows=v,y.numSpotShadows=S,y.numSpotMaps=b,y.numLightProbes=R,i.version=b2++)}function l(c,h){let d=0,u=0,p=0,_=0,x=0;const g=h.matrixWorldInverse;for(let f=0,m=c.length;f<m;f++){const v=c[f];if(v.isDirectionalLight){const S=i.directional[d];S.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),S.direction.sub(r),S.direction.transformDirection(g),d++}else if(v.isSpotLight){const S=i.spot[p];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(g),S.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),S.direction.sub(r),S.direction.transformDirection(g),p++}else if(v.isRectAreaLight){const S=i.rectArea[_];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(g),o.identity(),s.copy(v.matrixWorld),s.premultiply(g),o.extractRotation(s),S.halfWidth.set(v.width*.5,0,0),S.halfHeight.set(0,v.height*.5,0),S.halfWidth.applyMatrix4(o),S.halfHeight.applyMatrix4(o),_++}else if(v.isPointLight){const S=i.point[u];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(g),u++}else if(v.isHemisphereLight){const S=i.hemi[x];S.direction.setFromMatrixPosition(v.matrixWorld),S.direction.transformDirection(g),x++}}}return{setup:a,setupView:l,state:i}}function d0(t){const e=new A2(t),n=[],i=[],r=[];function s(u){d.camera=u,n.length=0,i.length=0,r.length=0}function o(u){n.push(u)}function a(u){i.push(u)}function l(u){r.push(u)}function c(){e.setup(n)}function h(u){e.setupView(n,u)}const d={lightsArray:n,shadowsArray:i,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:d,setupLights:c,setupLightsView:h,pushLight:o,pushShadow:a,pushLightProbeGrid:l}}function C2(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new d0(t),e.set(r,[a])):s>=o.length?(a=new d0(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}const R2=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,L2=[new O(1,0,0),new O(-1,0,0),new O(0,1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1)],D2=[new O(0,-1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1),new O(0,-1,0),new O(0,-1,0)],f0=new He,No=new O,ph=new O;function N2(t,e,n){let i=new xp;const r=new Ge,s=new Ge,o=new Nt,a=new Uw,l=new kw,c={},h=n.maxTextureSize,d={[Mr]:Cn,[Cn]:Mr,[un]:un},u=new dn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ge},radius:{value:4}},vertexShader:R2,fragmentShader:P2}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const _=new Ht;_.setAttribute("position",new ci(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new en(_,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Hl;let f=this.type;this.render=function(w,R,y){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||w.length===0)return;this.type===sx&&(je("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Hl);const C=t.getRenderTarget(),U=t.getActiveCubeFace(),D=t.getActiveMipmapLevel(),z=t.state;z.setBlending(wi),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const B=f!==this.type;B&&R.traverse(function(X){X.material&&(Array.isArray(X.material)?X.material.forEach(k=>k.needsUpdate=!0):X.material.needsUpdate=!0)});for(let X=0,k=w.length;X<k;X++){const V=w[X],L=V.shadow;if(L===void 0){je("WebGLShadowMap:",V,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;r.copy(L.mapSize);const N=L.getFrameExtents();r.multiply(N),s.copy(L.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/N.x),r.x=s.x*N.x,L.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/N.y),r.y=s.y*N.y,L.mapSize.y=s.y));const P=t.state.buffers.depth.getReversed();if(L.camera._reversedDepth=P,L.map===null||B===!0){if(L.map!==null&&(L.map.depthTexture!==null&&(L.map.depthTexture.dispose(),L.map.depthTexture=null),L.map.dispose()),this.type===Oo){if(V.isPointLight){je("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}L.map=new Rn(r.x,r.y,{format:Qr,type:Bn,minFilter:Yt,magFilter:Yt,generateMipmaps:!1}),L.map.texture.name=V.name+".shadowMap",L.map.depthTexture=new oo(r.x,r.y,xi),L.map.depthTexture.name=V.name+".shadowMapDepth",L.map.depthTexture.format=Wi,L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=Mt,L.map.depthTexture.magFilter=Mt}else V.isPointLight?(L.map=new Ix(r.x),L.map.depthTexture=new Pw(r.x,bi)):(L.map=new Rn(r.x,r.y),L.map.depthTexture=new oo(r.x,r.y,bi)),L.map.depthTexture.name=V.name+".shadowMap",L.map.depthTexture.format=Wi,this.type===Hl?(L.map.depthTexture.compareFunction=P?mp:pp,L.map.depthTexture.minFilter=Yt,L.map.depthTexture.magFilter=Yt):(L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=Mt,L.map.depthTexture.magFilter=Mt);L.camera.updateProjectionMatrix()}const T=L.map.isWebGLCubeRenderTarget?6:1;for(let Z=0;Z<T;Z++){if(L.map.isWebGLCubeRenderTarget)t.setRenderTarget(L.map,Z),t.clear();else{Z===0&&(t.setRenderTarget(L.map),t.clear());const Y=L.getViewport(Z);o.set(s.x*Y.x,s.y*Y.y,s.x*Y.z,s.y*Y.w),z.viewport(o)}if(V.isPointLight){const Y=L.camera,ne=L.matrix,K=V.distance||Y.far;K!==Y.far&&(Y.far=K,Y.updateProjectionMatrix()),No.setFromMatrixPosition(V.matrixWorld),Y.position.copy(No),ph.copy(Y.position),ph.add(L2[Z]),Y.up.copy(D2[Z]),Y.lookAt(ph),Y.updateMatrixWorld(),ne.makeTranslation(-No.x,-No.y,-No.z),f0.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),L._frustum.setFromProjectionMatrix(f0,Y.coordinateSystem,Y.reversedDepth)}else L.updateMatrices(V);i=L.getFrustum(),S(R,y,L.camera,V,this.type)}L.isPointLightShadow!==!0&&this.type===Oo&&m(L,y),L.needsUpdate=!1}f=this.type,g.needsUpdate=!1,t.setRenderTarget(C,U,D)};function m(w,R){const y=e.update(x);u.defines.VSM_SAMPLES!==w.blurSamples&&(u.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Rn(r.x,r.y,{format:Qr,type:Bn})),u.uniforms.shadow_pass.value=w.map.depthTexture,u.uniforms.resolution.value=w.mapSize,u.uniforms.radius.value=w.radius,t.setRenderTarget(w.mapPass),t.clear(),t.renderBufferDirect(R,null,y,u,x,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,t.setRenderTarget(w.map),t.clear(),t.renderBufferDirect(R,null,y,p,x,null)}function v(w,R,y,C){let U=null;const D=y.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(D!==void 0)U=D;else if(U=y.isPointLight===!0?l:a,t.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const z=U.uuid,B=R.uuid;let X=c[z];X===void 0&&(X={},c[z]=X);let k=X[B];k===void 0&&(k=U.clone(),X[B]=k,R.addEventListener("dispose",b)),U=k}if(U.visible=R.visible,U.wireframe=R.wireframe,C===Oo?U.side=R.shadowSide!==null?R.shadowSide:R.side:U.side=R.shadowSide!==null?R.shadowSide:d[R.side],U.alphaMap=R.alphaMap,U.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,U.map=R.map,U.clipShadows=R.clipShadows,U.clippingPlanes=R.clippingPlanes,U.clipIntersection=R.clipIntersection,U.displacementMap=R.displacementMap,U.displacementScale=R.displacementScale,U.displacementBias=R.displacementBias,U.wireframeLinewidth=R.wireframeLinewidth,U.linewidth=R.linewidth,y.isPointLight===!0&&U.isMeshDistanceMaterial===!0){const z=t.properties.get(U);z.light=y}return U}function S(w,R,y,C,U){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&U===Oo)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,w.matrixWorld);const B=e.update(w),X=w.material;if(Array.isArray(X)){const k=B.groups;for(let V=0,L=k.length;V<L;V++){const N=k[V],P=X[N.materialIndex];if(P&&P.visible){const T=v(w,P,C,U);w.onBeforeShadow(t,w,R,y,B,T,N),t.renderBufferDirect(y,null,B,T,w,N),w.onAfterShadow(t,w,R,y,B,T,N)}}}else if(X.visible){const k=v(w,X,C,U);w.onBeforeShadow(t,w,R,y,B,k,null),t.renderBufferDirect(y,null,B,k,w,null),w.onAfterShadow(t,w,R,y,B,k,null)}}const z=w.children;for(let B=0,X=z.length;B<X;B++)S(z[B],R,y,C,U)}function b(w){w.target.removeEventListener("dispose",b);for(const y in c){const C=c[y],U=w.target.uuid;U in C&&(C[U].dispose(),delete C[U])}}}function I2(t,e){function n(){let H=!1;const ve=new Nt;let oe=null;const Le=new Nt(0,0,0,0);return{setMask:function(Me){oe!==Me&&!H&&(t.colorMask(Me,Me,Me,Me),oe=Me)},setLocked:function(Me){H=Me},setClear:function(Me,fe,Oe,Ye,It){It===!0&&(Me*=Ye,fe*=Ye,Oe*=Ye),ve.set(Me,fe,Oe,Ye),Le.equals(ve)===!1&&(t.clearColor(Me,fe,Oe,Ye),Le.copy(ve))},reset:function(){H=!1,oe=null,Le.set(-1,0,0,0)}}}function i(){let H=!1,ve=!1,oe=null,Le=null,Me=null;return{setReversed:function(fe){if(ve!==fe){const Oe=e.get("EXT_clip_control");fe?Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.ZERO_TO_ONE_EXT):Oe.clipControlEXT(Oe.LOWER_LEFT_EXT,Oe.NEGATIVE_ONE_TO_ONE_EXT),ve=fe;const Ye=Me;Me=null,this.setClear(Ye)}},getReversed:function(){return ve},setTest:function(fe){fe?q(t.DEPTH_TEST):se(t.DEPTH_TEST)},setMask:function(fe){oe!==fe&&!H&&(t.depthMask(fe),oe=fe)},setFunc:function(fe){if(ve&&(fe=GM[fe]),Le!==fe){switch(fe){case vd:t.depthFunc(t.NEVER);break;case xd:t.depthFunc(t.ALWAYS);break;case yd:t.depthFunc(t.LESS);break;case io:t.depthFunc(t.LEQUAL);break;case Sd:t.depthFunc(t.EQUAL);break;case Md:t.depthFunc(t.GEQUAL);break;case wd:t.depthFunc(t.GREATER);break;case Ed:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}Le=fe}},setLocked:function(fe){H=fe},setClear:function(fe){Me!==fe&&(Me=fe,ve&&(fe=1-fe),t.clearDepth(fe))},reset:function(){H=!1,oe=null,Le=null,Me=null,ve=!1}}}function r(){let H=!1,ve=null,oe=null,Le=null,Me=null,fe=null,Oe=null,Ye=null,It=null;return{setTest:function(gt){H||(gt?q(t.STENCIL_TEST):se(t.STENCIL_TEST))},setMask:function(gt){ve!==gt&&!H&&(t.stencilMask(gt),ve=gt)},setFunc:function(gt,Ti,hi){(oe!==gt||Le!==Ti||Me!==hi)&&(t.stencilFunc(gt,Ti,hi),oe=gt,Le=Ti,Me=hi)},setOp:function(gt,Ti,hi){(fe!==gt||Oe!==Ti||Ye!==hi)&&(t.stencilOp(gt,Ti,hi),fe=gt,Oe=Ti,Ye=hi)},setLocked:function(gt){H=gt},setClear:function(gt){It!==gt&&(t.clearStencil(gt),It=gt)},reset:function(){H=!1,ve=null,oe=null,Le=null,Me=null,fe=null,Oe=null,Ye=null,It=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let h={},d={},u={},p=new WeakMap,_=[],x=null,g=!1,f=null,m=null,v=null,S=null,b=null,w=null,R=null,y=new Qe(0,0,0),C=0,U=!1,D=null,z=null,B=null,X=null,k=null;const V=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let L=!1,N=0;const P=t.getParameter(t.VERSION);P.indexOf("WebGL")!==-1?(N=parseFloat(/^WebGL (\d)/.exec(P)[1]),L=N>=1):P.indexOf("OpenGL ES")!==-1&&(N=parseFloat(/^OpenGL ES (\d)/.exec(P)[1]),L=N>=2);let T=null,Z={};const Y=t.getParameter(t.SCISSOR_BOX),ne=t.getParameter(t.VIEWPORT),K=new Nt().fromArray(Y),te=new Nt().fromArray(ne);function G(H,ve,oe,Le){const Me=new Uint8Array(4),fe=t.createTexture();t.bindTexture(H,fe),t.texParameteri(H,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(H,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Oe=0;Oe<oe;Oe++)H===t.TEXTURE_3D||H===t.TEXTURE_2D_ARRAY?t.texImage3D(ve,0,t.RGBA,1,1,Le,0,t.RGBA,t.UNSIGNED_BYTE,Me):t.texImage2D(ve+Oe,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,Me);return fe}const W={};W[t.TEXTURE_2D]=G(t.TEXTURE_2D,t.TEXTURE_2D,1),W[t.TEXTURE_CUBE_MAP]=G(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),W[t.TEXTURE_2D_ARRAY]=G(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),W[t.TEXTURE_3D]=G(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),q(t.DEPTH_TEST),o.setFunc(io),ie(!1),ce(rg),q(t.CULL_FACE),Fe(wi);function q(H){h[H]!==!0&&(t.enable(H),h[H]=!0)}function se(H){h[H]!==!1&&(t.disable(H),h[H]=!1)}function ue(H,ve){return u[H]!==ve?(t.bindFramebuffer(H,ve),u[H]=ve,H===t.DRAW_FRAMEBUFFER&&(u[t.FRAMEBUFFER]=ve),H===t.FRAMEBUFFER&&(u[t.DRAW_FRAMEBUFFER]=ve),!0):!1}function de(H,ve){let oe=_,Le=!1;if(H){oe=p.get(ve),oe===void 0&&(oe=[],p.set(ve,oe));const Me=H.textures;if(oe.length!==Me.length||oe[0]!==t.COLOR_ATTACHMENT0){for(let fe=0,Oe=Me.length;fe<Oe;fe++)oe[fe]=t.COLOR_ATTACHMENT0+fe;oe.length=Me.length,Le=!0}}else oe[0]!==t.BACK&&(oe[0]=t.BACK,Le=!0);Le&&t.drawBuffers(oe)}function Re(H){return x!==H?(t.useProgram(H),x=H,!0):!1}const xe={[kr]:t.FUNC_ADD,[dM]:t.FUNC_SUBTRACT,[fM]:t.FUNC_REVERSE_SUBTRACT};xe[pM]=t.MIN,xe[mM]=t.MAX;const Ve={[gM]:t.ZERO,[_M]:t.ONE,[vM]:t.SRC_COLOR,[gd]:t.SRC_ALPHA,[EM]:t.SRC_ALPHA_SATURATE,[MM]:t.DST_COLOR,[yM]:t.DST_ALPHA,[xM]:t.ONE_MINUS_SRC_COLOR,[_d]:t.ONE_MINUS_SRC_ALPHA,[wM]:t.ONE_MINUS_DST_COLOR,[SM]:t.ONE_MINUS_DST_ALPHA,[bM]:t.CONSTANT_COLOR,[TM]:t.ONE_MINUS_CONSTANT_COLOR,[AM]:t.CONSTANT_ALPHA,[CM]:t.ONE_MINUS_CONSTANT_ALPHA};function Fe(H,ve,oe,Le,Me,fe,Oe,Ye,It,gt){if(H===wi){g===!0&&(se(t.BLEND),g=!1);return}if(g===!1&&(q(t.BLEND),g=!0),H!==hM){if(H!==f||gt!==U){if((m!==kr||b!==kr)&&(t.blendEquation(t.FUNC_ADD),m=kr,b=kr),gt)switch(H){case Gs:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case md:t.blendFunc(t.ONE,t.ONE);break;case sg:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case og:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:lt("WebGLState: Invalid blending: ",H);break}else switch(H){case Gs:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case md:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case sg:lt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case og:lt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:lt("WebGLState: Invalid blending: ",H);break}v=null,S=null,w=null,R=null,y.set(0,0,0),C=0,f=H,U=gt}return}Me=Me||ve,fe=fe||oe,Oe=Oe||Le,(ve!==m||Me!==b)&&(t.blendEquationSeparate(xe[ve],xe[Me]),m=ve,b=Me),(oe!==v||Le!==S||fe!==w||Oe!==R)&&(t.blendFuncSeparate(Ve[oe],Ve[Le],Ve[fe],Ve[Oe]),v=oe,S=Le,w=fe,R=Oe),(Ye.equals(y)===!1||It!==C)&&(t.blendColor(Ye.r,Ye.g,Ye.b,It),y.copy(Ye),C=It),f=H,U=!1}function Ae(H,ve){H.side===un?se(t.CULL_FACE):q(t.CULL_FACE);let oe=H.side===Cn;ve&&(oe=!oe),ie(oe),H.blending===Gs&&H.transparent===!1?Fe(wi):Fe(H.blending,H.blendEquation,H.blendSrc,H.blendDst,H.blendEquationAlpha,H.blendSrcAlpha,H.blendDstAlpha,H.blendColor,H.blendAlpha,H.premultipliedAlpha),o.setFunc(H.depthFunc),o.setTest(H.depthTest),o.setMask(H.depthWrite),s.setMask(H.colorWrite);const Le=H.stencilWrite;a.setTest(Le),Le&&(a.setMask(H.stencilWriteMask),a.setFunc(H.stencilFunc,H.stencilRef,H.stencilFuncMask),a.setOp(H.stencilFail,H.stencilZFail,H.stencilZPass)),I(H.polygonOffset,H.polygonOffsetFactor,H.polygonOffsetUnits),H.alphaToCoverage===!0?q(t.SAMPLE_ALPHA_TO_COVERAGE):se(t.SAMPLE_ALPHA_TO_COVERAGE)}function ie(H){D!==H&&(H?t.frontFace(t.CW):t.frontFace(t.CCW),D=H)}function ce(H){H!==cM?(q(t.CULL_FACE),H!==z&&(H===rg?t.cullFace(t.BACK):H===uM?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):se(t.CULL_FACE),z=H}function Ee(H){H!==B&&(L&&t.lineWidth(H),B=H)}function I(H,ve,oe){H?(q(t.POLYGON_OFFSET_FILL),(X!==ve||k!==oe)&&(X=ve,k=oe,o.getReversed()&&(ve=-ve),t.polygonOffset(ve,oe))):se(t.POLYGON_OFFSET_FILL)}function ye(H){H?q(t.SCISSOR_TEST):se(t.SCISSOR_TEST)}function Xe(H){H===void 0&&(H=t.TEXTURE0+V-1),T!==H&&(t.activeTexture(H),T=H)}function st(H,ve,oe){oe===void 0&&(T===null?oe=t.TEXTURE0+V-1:oe=T);let Le=Z[oe];Le===void 0&&(Le={type:void 0,texture:void 0},Z[oe]=Le),(Le.type!==H||Le.texture!==ve)&&(T!==oe&&(t.activeTexture(oe),T=oe),t.bindTexture(H,ve||W[H]),Le.type=H,Le.texture=ve)}function ge(){const H=Z[T];H!==void 0&&H.type!==void 0&&(t.bindTexture(H.type,null),H.type=void 0,H.texture=void 0)}function ot(){try{t.compressedTexImage2D(...arguments)}catch(H){lt("WebGLState:",H)}}function A(){try{t.compressedTexImage3D(...arguments)}catch(H){lt("WebGLState:",H)}}function M(){try{t.texSubImage2D(...arguments)}catch(H){lt("WebGLState:",H)}}function $(){try{t.texSubImage3D(...arguments)}catch(H){lt("WebGLState:",H)}}function ae(){try{t.compressedTexSubImage2D(...arguments)}catch(H){lt("WebGLState:",H)}}function he(){try{t.compressedTexSubImage3D(...arguments)}catch(H){lt("WebGLState:",H)}}function me(){try{t.texStorage2D(...arguments)}catch(H){lt("WebGLState:",H)}}function we(){try{t.texStorage3D(...arguments)}catch(H){lt("WebGLState:",H)}}function re(){try{t.texImage2D(...arguments)}catch(H){lt("WebGLState:",H)}}function le(){try{t.texImage3D(...arguments)}catch(H){lt("WebGLState:",H)}}function Pe(H){return d[H]!==void 0?d[H]:t.getParameter(H)}function Ne(H,ve){d[H]!==ve&&(t.pixelStorei(H,ve),d[H]=ve)}function Se(H){K.equals(H)===!1&&(t.scissor(H.x,H.y,H.z,H.w),K.copy(H))}function _e(H){te.equals(H)===!1&&(t.viewport(H.x,H.y,H.z,H.w),te.copy(H))}function qe(H,ve){let oe=c.get(ve);oe===void 0&&(oe=new WeakMap,c.set(ve,oe));let Le=oe.get(H);Le===void 0&&(Le=t.getUniformBlockIndex(ve,H.name),oe.set(H,Le))}function Ze(H,ve){const Le=c.get(ve).get(H);l.get(ve)!==Le&&(t.uniformBlockBinding(ve,Le,H.__bindingPointIndex),l.set(ve,Le))}function dt(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),h={},d={},T=null,Z={},u={},p=new WeakMap,_=[],x=null,g=!1,f=null,m=null,v=null,S=null,b=null,w=null,R=null,y=new Qe(0,0,0),C=0,U=!1,D=null,z=null,B=null,X=null,k=null,K.set(0,0,t.canvas.width,t.canvas.height),te.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:q,disable:se,bindFramebuffer:ue,drawBuffers:de,useProgram:Re,setBlending:Fe,setMaterial:Ae,setFlipSided:ie,setCullFace:ce,setLineWidth:Ee,setPolygonOffset:I,setScissorTest:ye,activeTexture:Xe,bindTexture:st,unbindTexture:ge,compressedTexImage2D:ot,compressedTexImage3D:A,texImage2D:re,texImage3D:le,pixelStorei:Ne,getParameter:Pe,updateUBOMapping:qe,uniformBlockBinding:Ze,texStorage2D:me,texStorage3D:we,texSubImage2D:M,texSubImage3D:$,compressedTexSubImage2D:ae,compressedTexSubImage3D:he,scissor:Se,viewport:_e,reset:dt}}function U2(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ge,h=new WeakMap,d=new Set;let u;const p=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(A,M){return _?new OffscreenCanvas(A,M):_a("canvas")}function g(A,M,$){let ae=1;const he=ot(A);if((he.width>$||he.height>$)&&(ae=$/Math.max(he.width,he.height)),ae<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const me=Math.floor(ae*he.width),we=Math.floor(ae*he.height);u===void 0&&(u=x(me,we));const re=M?x(me,we):u;return re.width=me,re.height=we,re.getContext("2d").drawImage(A,0,0,me,we),je("WebGLRenderer: Texture has been resized from ("+he.width+"x"+he.height+") to ("+me+"x"+we+")."),re}else return"data"in A&&je("WebGLRenderer: Image in DataTexture is too big ("+he.width+"x"+he.height+")."),A;return A}function f(A){return A.generateMipmaps}function m(A){t.generateMipmap(A)}function v(A){return A.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?t.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function S(A,M,$,ae,he,me=!1){if(A!==null){if(t[A]!==void 0)return t[A];je("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let we;ae&&(we=e.get("EXT_texture_norm16"),we||je("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let re=M;if(M===t.RED&&($===t.FLOAT&&(re=t.R32F),$===t.HALF_FLOAT&&(re=t.R16F),$===t.UNSIGNED_BYTE&&(re=t.R8),$===t.UNSIGNED_SHORT&&we&&(re=we.R16_EXT),$===t.SHORT&&we&&(re=we.R16_SNORM_EXT)),M===t.RED_INTEGER&&($===t.UNSIGNED_BYTE&&(re=t.R8UI),$===t.UNSIGNED_SHORT&&(re=t.R16UI),$===t.UNSIGNED_INT&&(re=t.R32UI),$===t.BYTE&&(re=t.R8I),$===t.SHORT&&(re=t.R16I),$===t.INT&&(re=t.R32I)),M===t.RG&&($===t.FLOAT&&(re=t.RG32F),$===t.HALF_FLOAT&&(re=t.RG16F),$===t.UNSIGNED_BYTE&&(re=t.RG8),$===t.UNSIGNED_SHORT&&we&&(re=we.RG16_EXT),$===t.SHORT&&we&&(re=we.RG16_SNORM_EXT)),M===t.RG_INTEGER&&($===t.UNSIGNED_BYTE&&(re=t.RG8UI),$===t.UNSIGNED_SHORT&&(re=t.RG16UI),$===t.UNSIGNED_INT&&(re=t.RG32UI),$===t.BYTE&&(re=t.RG8I),$===t.SHORT&&(re=t.RG16I),$===t.INT&&(re=t.RG32I)),M===t.RGB_INTEGER&&($===t.UNSIGNED_BYTE&&(re=t.RGB8UI),$===t.UNSIGNED_SHORT&&(re=t.RGB16UI),$===t.UNSIGNED_INT&&(re=t.RGB32UI),$===t.BYTE&&(re=t.RGB8I),$===t.SHORT&&(re=t.RGB16I),$===t.INT&&(re=t.RGB32I)),M===t.RGBA_INTEGER&&($===t.UNSIGNED_BYTE&&(re=t.RGBA8UI),$===t.UNSIGNED_SHORT&&(re=t.RGBA16UI),$===t.UNSIGNED_INT&&(re=t.RGBA32UI),$===t.BYTE&&(re=t.RGBA8I),$===t.SHORT&&(re=t.RGBA16I),$===t.INT&&(re=t.RGBA32I)),M===t.RGB&&($===t.UNSIGNED_SHORT&&we&&(re=we.RGB16_EXT),$===t.SHORT&&we&&(re=we.RGB16_SNORM_EXT),$===t.UNSIGNED_INT_5_9_9_9_REV&&(re=t.RGB9_E5),$===t.UNSIGNED_INT_10F_11F_11F_REV&&(re=t.R11F_G11F_B10F)),M===t.RGBA){const le=me?Mc:rt.getTransfer(he);$===t.FLOAT&&(re=t.RGBA32F),$===t.HALF_FLOAT&&(re=t.RGBA16F),$===t.UNSIGNED_BYTE&&(re=le===pt?t.SRGB8_ALPHA8:t.RGBA8),$===t.UNSIGNED_SHORT&&we&&(re=we.RGBA16_EXT),$===t.SHORT&&we&&(re=we.RGBA16_SNORM_EXT),$===t.UNSIGNED_SHORT_4_4_4_4&&(re=t.RGBA4),$===t.UNSIGNED_SHORT_5_5_5_1&&(re=t.RGB5_A1)}return(re===t.R16F||re===t.R32F||re===t.RG16F||re===t.RG32F||re===t.RGBA16F||re===t.RGBA32F)&&e.get("EXT_color_buffer_float"),re}function b(A,M){let $;return A?M===null||M===bi||M===ma?$=t.DEPTH24_STENCIL8:M===xi?$=t.DEPTH32F_STENCIL8:M===pa&&($=t.DEPTH24_STENCIL8,je("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===bi||M===ma?$=t.DEPTH_COMPONENT24:M===xi?$=t.DEPTH_COMPONENT32F:M===pa&&($=t.DEPTH_COMPONENT16),$}function w(A,M){return f(A)===!0||A.isFramebufferTexture&&A.minFilter!==Mt&&A.minFilter!==Yt?Math.log2(Math.max(M.width,M.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?M.mipmaps.length:1}function R(A){const M=A.target;M.removeEventListener("dispose",R),C(M),M.isVideoTexture&&h.delete(M),M.isHTMLTexture&&d.delete(M)}function y(A){const M=A.target;M.removeEventListener("dispose",y),D(M)}function C(A){const M=i.get(A);if(M.__webglInit===void 0)return;const $=A.source,ae=p.get($);if(ae){const he=ae[M.__cacheKey];he.usedTimes--,he.usedTimes===0&&U(A),Object.keys(ae).length===0&&p.delete($)}i.remove(A)}function U(A){const M=i.get(A);t.deleteTexture(M.__webglTexture);const $=A.source,ae=p.get($);delete ae[M.__cacheKey],o.memory.textures--}function D(A){const M=i.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),i.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let ae=0;ae<6;ae++){if(Array.isArray(M.__webglFramebuffer[ae]))for(let he=0;he<M.__webglFramebuffer[ae].length;he++)t.deleteFramebuffer(M.__webglFramebuffer[ae][he]);else t.deleteFramebuffer(M.__webglFramebuffer[ae]);M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer[ae])}else{if(Array.isArray(M.__webglFramebuffer))for(let ae=0;ae<M.__webglFramebuffer.length;ae++)t.deleteFramebuffer(M.__webglFramebuffer[ae]);else t.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&t.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let ae=0;ae<M.__webglColorRenderbuffer.length;ae++)M.__webglColorRenderbuffer[ae]&&t.deleteRenderbuffer(M.__webglColorRenderbuffer[ae]);M.__webglDepthRenderbuffer&&t.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const $=A.textures;for(let ae=0,he=$.length;ae<he;ae++){const me=i.get($[ae]);me.__webglTexture&&(t.deleteTexture(me.__webglTexture),o.memory.textures--),i.remove($[ae])}i.remove(A)}let z=0;function B(){z=0}function X(){return z}function k(A){z=A}function V(){const A=z;return A>=r.maxTextures&&je("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),z+=1,A}function L(A){const M=[];return M.push(A.wrapS),M.push(A.wrapT),M.push(A.wrapR||0),M.push(A.magFilter),M.push(A.minFilter),M.push(A.anisotropy),M.push(A.internalFormat),M.push(A.format),M.push(A.type),M.push(A.generateMipmaps),M.push(A.premultiplyAlpha),M.push(A.flipY),M.push(A.unpackAlignment),M.push(A.colorSpace),M.join()}function N(A,M){const $=i.get(A);if(A.isVideoTexture&&st(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&$.__version!==A.version){const ae=A.image;if(ae===null)je("WebGLRenderer: Texture marked for update but no image data found.");else if(ae.complete===!1)je("WebGLRenderer: Texture marked for update but image is incomplete");else{se($,A,M);return}}else A.isExternalTexture&&($.__webglTexture=A.sourceTexture?A.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,$.__webglTexture,t.TEXTURE0+M)}function P(A,M){const $=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&$.__version!==A.version){se($,A,M);return}else A.isExternalTexture&&($.__webglTexture=A.sourceTexture?A.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,$.__webglTexture,t.TEXTURE0+M)}function T(A,M){const $=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&$.__version!==A.version){se($,A,M);return}n.bindTexture(t.TEXTURE_3D,$.__webglTexture,t.TEXTURE0+M)}function Z(A,M){const $=i.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&$.__version!==A.version){ue($,A,M);return}n.bindTexture(t.TEXTURE_CUBE_MAP,$.__webglTexture,t.TEXTURE0+M)}const Y={[bd]:t.REPEAT,[Fi]:t.CLAMP_TO_EDGE,[Td]:t.MIRRORED_REPEAT},ne={[Mt]:t.NEAREST,[LM]:t.NEAREST_MIPMAP_NEAREST,[Za]:t.NEAREST_MIPMAP_LINEAR,[Yt]:t.LINEAR,[Nu]:t.LINEAR_MIPMAP_NEAREST,[ur]:t.LINEAR_MIPMAP_LINEAR},K={[IM]:t.NEVER,[BM]:t.ALWAYS,[UM]:t.LESS,[pp]:t.LEQUAL,[kM]:t.EQUAL,[mp]:t.GEQUAL,[FM]:t.GREATER,[OM]:t.NOTEQUAL};function te(A,M){if(M.type===xi&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Yt||M.magFilter===Nu||M.magFilter===Za||M.magFilter===ur||M.minFilter===Yt||M.minFilter===Nu||M.minFilter===Za||M.minFilter===ur)&&je("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(A,t.TEXTURE_WRAP_S,Y[M.wrapS]),t.texParameteri(A,t.TEXTURE_WRAP_T,Y[M.wrapT]),(A===t.TEXTURE_3D||A===t.TEXTURE_2D_ARRAY)&&t.texParameteri(A,t.TEXTURE_WRAP_R,Y[M.wrapR]),t.texParameteri(A,t.TEXTURE_MAG_FILTER,ne[M.magFilter]),t.texParameteri(A,t.TEXTURE_MIN_FILTER,ne[M.minFilter]),M.compareFunction&&(t.texParameteri(A,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(A,t.TEXTURE_COMPARE_FUNC,K[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Mt||M.minFilter!==Za&&M.minFilter!==ur||M.type===xi&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const $=e.get("EXT_texture_filter_anisotropic");t.texParameterf(A,$.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function G(A,M){let $=!1;A.__webglInit===void 0&&(A.__webglInit=!0,M.addEventListener("dispose",R));const ae=M.source;let he=p.get(ae);he===void 0&&(he={},p.set(ae,he));const me=L(M);if(me!==A.__cacheKey){he[me]===void 0&&(he[me]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,$=!0),he[me].usedTimes++;const we=he[A.__cacheKey];we!==void 0&&(he[A.__cacheKey].usedTimes--,we.usedTimes===0&&U(M)),A.__cacheKey=me,A.__webglTexture=he[me].texture}return $}function W(A,M,$){return Math.floor(Math.floor(A/$)/M)}function q(A,M,$,ae){const me=A.updateRanges;if(me.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,M.width,M.height,$,ae,M.data);else{me.sort((Ne,Se)=>Ne.start-Se.start);let we=0;for(let Ne=1;Ne<me.length;Ne++){const Se=me[we],_e=me[Ne],qe=Se.start+Se.count,Ze=W(_e.start,M.width,4),dt=W(Se.start,M.width,4);_e.start<=qe+1&&Ze===dt&&W(_e.start+_e.count-1,M.width,4)===Ze?Se.count=Math.max(Se.count,_e.start+_e.count-Se.start):(++we,me[we]=_e)}me.length=we+1;const re=n.getParameter(t.UNPACK_ROW_LENGTH),le=n.getParameter(t.UNPACK_SKIP_PIXELS),Pe=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,M.width);for(let Ne=0,Se=me.length;Ne<Se;Ne++){const _e=me[Ne],qe=Math.floor(_e.start/4),Ze=Math.ceil(_e.count/4),dt=qe%M.width,H=Math.floor(qe/M.width),ve=Ze,oe=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,dt),n.pixelStorei(t.UNPACK_SKIP_ROWS,H),n.texSubImage2D(t.TEXTURE_2D,0,dt,H,ve,oe,$,ae,M.data)}A.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,re),n.pixelStorei(t.UNPACK_SKIP_PIXELS,le),n.pixelStorei(t.UNPACK_SKIP_ROWS,Pe)}}function se(A,M,$){let ae=t.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(ae=t.TEXTURE_2D_ARRAY),M.isData3DTexture&&(ae=t.TEXTURE_3D);const he=G(A,M),me=M.source;n.bindTexture(ae,A.__webglTexture,t.TEXTURE0+$);const we=i.get(me);if(me.version!==we.__version||he===!0){if(n.activeTexture(t.TEXTURE0+$),(typeof ImageBitmap<"u"&&M.image instanceof ImageBitmap)===!1){const oe=rt.getPrimaries(rt.workingColorSpace),Le=M.colorSpace===ar?null:rt.getPrimaries(M.colorSpace),Me=M.colorSpace===ar||oe===Le?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Me)}n.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment);let le=g(M.image,!1,r.maxTextureSize);le=ge(M,le);const Pe=s.convert(M.format,M.colorSpace),Ne=s.convert(M.type);let Se=S(M.internalFormat,Pe,Ne,M.normalized,M.colorSpace,M.isVideoTexture);te(ae,M);let _e;const qe=M.mipmaps,Ze=M.isVideoTexture!==!0,dt=we.__version===void 0||he===!0,H=me.dataReady,ve=w(M,le);if(M.isDepthTexture)Se=b(M.format===Vr,M.type),dt&&(Ze?n.texStorage2D(t.TEXTURE_2D,1,Se,le.width,le.height):n.texImage2D(t.TEXTURE_2D,0,Se,le.width,le.height,0,Pe,Ne,null));else if(M.isDataTexture)if(qe.length>0){Ze&&dt&&n.texStorage2D(t.TEXTURE_2D,ve,Se,qe[0].width,qe[0].height);for(let oe=0,Le=qe.length;oe<Le;oe++)_e=qe[oe],Ze?H&&n.texSubImage2D(t.TEXTURE_2D,oe,0,0,_e.width,_e.height,Pe,Ne,_e.data):n.texImage2D(t.TEXTURE_2D,oe,Se,_e.width,_e.height,0,Pe,Ne,_e.data);M.generateMipmaps=!1}else Ze?(dt&&n.texStorage2D(t.TEXTURE_2D,ve,Se,le.width,le.height),H&&q(M,le,Pe,Ne)):n.texImage2D(t.TEXTURE_2D,0,Se,le.width,le.height,0,Pe,Ne,le.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Ze&&dt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ve,Se,qe[0].width,qe[0].height,le.depth);for(let oe=0,Le=qe.length;oe<Le;oe++)if(_e=qe[oe],M.format!==oi)if(Pe!==null)if(Ze){if(H)if(M.layerUpdates.size>0){const Me=Wg(_e.width,_e.height,M.format,M.type);for(const fe of M.layerUpdates){const Oe=_e.data.subarray(fe*Me/_e.data.BYTES_PER_ELEMENT,(fe+1)*Me/_e.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,oe,0,0,fe,_e.width,_e.height,1,Pe,Oe)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,oe,0,0,0,_e.width,_e.height,le.depth,Pe,_e.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,oe,Se,_e.width,_e.height,le.depth,0,_e.data,0,0);else je("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ze?H&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,oe,0,0,0,_e.width,_e.height,le.depth,Pe,Ne,_e.data):n.texImage3D(t.TEXTURE_2D_ARRAY,oe,Se,_e.width,_e.height,le.depth,0,Pe,Ne,_e.data)}else{Ze&&dt&&n.texStorage2D(t.TEXTURE_2D,ve,Se,qe[0].width,qe[0].height);for(let oe=0,Le=qe.length;oe<Le;oe++)_e=qe[oe],M.format!==oi?Pe!==null?Ze?H&&n.compressedTexSubImage2D(t.TEXTURE_2D,oe,0,0,_e.width,_e.height,Pe,_e.data):n.compressedTexImage2D(t.TEXTURE_2D,oe,Se,_e.width,_e.height,0,_e.data):je("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ze?H&&n.texSubImage2D(t.TEXTURE_2D,oe,0,0,_e.width,_e.height,Pe,Ne,_e.data):n.texImage2D(t.TEXTURE_2D,oe,Se,_e.width,_e.height,0,Pe,Ne,_e.data)}else if(M.isDataArrayTexture)if(Ze){if(dt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ve,Se,le.width,le.height,le.depth),H)if(M.layerUpdates.size>0){const oe=Wg(le.width,le.height,M.format,M.type);for(const Le of M.layerUpdates){const Me=le.data.subarray(Le*oe/le.data.BYTES_PER_ELEMENT,(Le+1)*oe/le.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,Le,le.width,le.height,1,Pe,Ne,Me)}M.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,le.width,le.height,le.depth,Pe,Ne,le.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Se,le.width,le.height,le.depth,0,Pe,Ne,le.data);else if(M.isData3DTexture)Ze?(dt&&n.texStorage3D(t.TEXTURE_3D,ve,Se,le.width,le.height,le.depth),H&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,le.width,le.height,le.depth,Pe,Ne,le.data)):n.texImage3D(t.TEXTURE_3D,0,Se,le.width,le.height,le.depth,0,Pe,Ne,le.data);else if(M.isFramebufferTexture){if(dt)if(Ze)n.texStorage2D(t.TEXTURE_2D,ve,Se,le.width,le.height);else{let oe=le.width,Le=le.height;for(let Me=0;Me<ve;Me++)n.texImage2D(t.TEXTURE_2D,Me,Se,oe,Le,0,Pe,Ne,null),oe>>=1,Le>>=1}}else if(M.isHTMLTexture){if("texElementImage2D"in t){const oe=t.canvas;if(oe.hasAttribute("layoutsubtree")||oe.setAttribute("layoutsubtree","true"),le.parentNode!==oe){oe.appendChild(le),d.add(M),oe.onpaint=Ye=>{const It=Ye.changedElements;for(const gt of d)It.includes(gt.image)&&(gt.needsUpdate=!0)},oe.requestPaint();return}const Le=0,Me=t.RGBA,fe=t.RGBA,Oe=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,Le,Me,fe,Oe,le),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(qe.length>0){if(Ze&&dt){const oe=ot(qe[0]);n.texStorage2D(t.TEXTURE_2D,ve,Se,oe.width,oe.height)}for(let oe=0,Le=qe.length;oe<Le;oe++)_e=qe[oe],Ze?H&&n.texSubImage2D(t.TEXTURE_2D,oe,0,0,Pe,Ne,_e):n.texImage2D(t.TEXTURE_2D,oe,Se,Pe,Ne,_e);M.generateMipmaps=!1}else if(Ze){if(dt){const oe=ot(le);n.texStorage2D(t.TEXTURE_2D,ve,Se,oe.width,oe.height)}H&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Pe,Ne,le)}else n.texImage2D(t.TEXTURE_2D,0,Se,Pe,Ne,le);f(M)&&m(ae),we.__version=me.version,M.onUpdate&&M.onUpdate(M)}A.__version=M.version}function ue(A,M,$){if(M.image.length!==6)return;const ae=G(A,M),he=M.source;n.bindTexture(t.TEXTURE_CUBE_MAP,A.__webglTexture,t.TEXTURE0+$);const me=i.get(he);if(he.version!==me.__version||ae===!0){n.activeTexture(t.TEXTURE0+$);const we=rt.getPrimaries(rt.workingColorSpace),re=M.colorSpace===ar?null:rt.getPrimaries(M.colorSpace),le=M.colorSpace===ar||we===re?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,le);const Pe=M.isCompressedTexture||M.image[0].isCompressedTexture,Ne=M.image[0]&&M.image[0].isDataTexture,Se=[];for(let fe=0;fe<6;fe++)!Pe&&!Ne?Se[fe]=g(M.image[fe],!0,r.maxCubemapSize):Se[fe]=Ne?M.image[fe].image:M.image[fe],Se[fe]=ge(M,Se[fe]);const _e=Se[0],qe=s.convert(M.format,M.colorSpace),Ze=s.convert(M.type),dt=S(M.internalFormat,qe,Ze,M.normalized,M.colorSpace),H=M.isVideoTexture!==!0,ve=me.__version===void 0||ae===!0,oe=he.dataReady;let Le=w(M,_e);te(t.TEXTURE_CUBE_MAP,M);let Me;if(Pe){H&&ve&&n.texStorage2D(t.TEXTURE_CUBE_MAP,Le,dt,_e.width,_e.height);for(let fe=0;fe<6;fe++){Me=Se[fe].mipmaps;for(let Oe=0;Oe<Me.length;Oe++){const Ye=Me[Oe];M.format!==oi?qe!==null?H?oe&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Oe,0,0,Ye.width,Ye.height,qe,Ye.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Oe,dt,Ye.width,Ye.height,0,Ye.data):je("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):H?oe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Oe,0,0,Ye.width,Ye.height,qe,Ze,Ye.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Oe,dt,Ye.width,Ye.height,0,qe,Ze,Ye.data)}}}else{if(Me=M.mipmaps,H&&ve){Me.length>0&&Le++;const fe=ot(Se[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,Le,dt,fe.width,fe.height)}for(let fe=0;fe<6;fe++)if(Ne){H?oe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,0,0,Se[fe].width,Se[fe].height,qe,Ze,Se[fe].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,dt,Se[fe].width,Se[fe].height,0,qe,Ze,Se[fe].data);for(let Oe=0;Oe<Me.length;Oe++){const It=Me[Oe].image[fe].image;H?oe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Oe+1,0,0,It.width,It.height,qe,Ze,It.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Oe+1,dt,It.width,It.height,0,qe,Ze,It.data)}}else{H?oe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,0,0,qe,Ze,Se[fe]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,dt,qe,Ze,Se[fe]);for(let Oe=0;Oe<Me.length;Oe++){const Ye=Me[Oe];H?oe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Oe+1,0,0,qe,Ze,Ye.image[fe]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Oe+1,dt,qe,Ze,Ye.image[fe])}}}f(M)&&m(t.TEXTURE_CUBE_MAP),me.__version=he.version,M.onUpdate&&M.onUpdate(M)}A.__version=M.version}function de(A,M,$,ae,he,me){const we=s.convert($.format,$.colorSpace),re=s.convert($.type),le=S($.internalFormat,we,re,$.normalized,$.colorSpace),Pe=i.get(M),Ne=i.get($);if(Ne.__renderTarget=M,!Pe.__hasExternalTextures){const Se=Math.max(1,M.width>>me),_e=Math.max(1,M.height>>me);he===t.TEXTURE_3D||he===t.TEXTURE_2D_ARRAY?n.texImage3D(he,me,le,Se,_e,M.depth,0,we,re,null):n.texImage2D(he,me,le,Se,_e,0,we,re,null)}n.bindFramebuffer(t.FRAMEBUFFER,A),Xe(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ae,he,Ne.__webglTexture,0,ye(M)):(he===t.TEXTURE_2D||he>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&he<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,ae,he,Ne.__webglTexture,me),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Re(A,M,$){if(t.bindRenderbuffer(t.RENDERBUFFER,A),M.depthBuffer){const ae=M.depthTexture,he=ae&&ae.isDepthTexture?ae.type:null,me=b(M.stencilBuffer,he),we=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Xe(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ye(M),me,M.width,M.height):$?t.renderbufferStorageMultisample(t.RENDERBUFFER,ye(M),me,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,me,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,we,t.RENDERBUFFER,A)}else{const ae=M.textures;for(let he=0;he<ae.length;he++){const me=ae[he],we=s.convert(me.format,me.colorSpace),re=s.convert(me.type),le=S(me.internalFormat,we,re,me.normalized,me.colorSpace);Xe(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ye(M),le,M.width,M.height):$?t.renderbufferStorageMultisample(t.RENDERBUFFER,ye(M),le,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,le,M.width,M.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function xe(A,M,$){const ae=M.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,A),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const he=i.get(M.depthTexture);if(he.__renderTarget=M,(!he.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),ae){if(he.__webglInit===void 0&&(he.__webglInit=!0,M.depthTexture.addEventListener("dispose",R)),he.__webglTexture===void 0){he.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,he.__webglTexture),te(t.TEXTURE_CUBE_MAP,M.depthTexture);const Pe=s.convert(M.depthTexture.format),Ne=s.convert(M.depthTexture.type);let Se;M.depthTexture.format===Wi?Se=t.DEPTH_COMPONENT24:M.depthTexture.format===Vr&&(Se=t.DEPTH24_STENCIL8);for(let _e=0;_e<6;_e++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,Se,M.width,M.height,0,Pe,Ne,null)}}else N(M.depthTexture,0);const me=he.__webglTexture,we=ye(M),re=ae?t.TEXTURE_CUBE_MAP_POSITIVE_X+$:t.TEXTURE_2D,le=M.depthTexture.format===Vr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(M.depthTexture.format===Wi)Xe(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,le,re,me,0,we):t.framebufferTexture2D(t.FRAMEBUFFER,le,re,me,0);else if(M.depthTexture.format===Vr)Xe(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,le,re,me,0,we):t.framebufferTexture2D(t.FRAMEBUFFER,le,re,me,0);else throw new Error("Unknown depthTexture format")}function Ve(A){const M=i.get(A),$=A.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==A.depthTexture){const ae=A.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),ae){const he=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,ae.removeEventListener("dispose",he)};ae.addEventListener("dispose",he),M.__depthDisposeCallback=he}M.__boundDepthTexture=ae}if(A.depthTexture&&!M.__autoAllocateDepthBuffer)if($)for(let ae=0;ae<6;ae++)xe(M.__webglFramebuffer[ae],A,ae);else{const ae=A.texture.mipmaps;ae&&ae.length>0?xe(M.__webglFramebuffer[0],A,0):xe(M.__webglFramebuffer,A,0)}else if($){M.__webglDepthbuffer=[];for(let ae=0;ae<6;ae++)if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[ae]),M.__webglDepthbuffer[ae]===void 0)M.__webglDepthbuffer[ae]=t.createRenderbuffer(),Re(M.__webglDepthbuffer[ae],A,!1);else{const he=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,me=M.__webglDepthbuffer[ae];t.bindRenderbuffer(t.RENDERBUFFER,me),t.framebufferRenderbuffer(t.FRAMEBUFFER,he,t.RENDERBUFFER,me)}}else{const ae=A.texture.mipmaps;if(ae&&ae.length>0?n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=t.createRenderbuffer(),Re(M.__webglDepthbuffer,A,!1);else{const he=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,me=M.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,me),t.framebufferRenderbuffer(t.FRAMEBUFFER,he,t.RENDERBUFFER,me)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Fe(A,M,$){const ae=i.get(A);M!==void 0&&de(ae.__webglFramebuffer,A,A.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),$!==void 0&&Ve(A)}function Ae(A){const M=A.texture,$=i.get(A),ae=i.get(M);A.addEventListener("dispose",y);const he=A.textures,me=A.isWebGLCubeRenderTarget===!0,we=he.length>1;if(we||(ae.__webglTexture===void 0&&(ae.__webglTexture=t.createTexture()),ae.__version=M.version,o.memory.textures++),me){$.__webglFramebuffer=[];for(let re=0;re<6;re++)if(M.mipmaps&&M.mipmaps.length>0){$.__webglFramebuffer[re]=[];for(let le=0;le<M.mipmaps.length;le++)$.__webglFramebuffer[re][le]=t.createFramebuffer()}else $.__webglFramebuffer[re]=t.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){$.__webglFramebuffer=[];for(let re=0;re<M.mipmaps.length;re++)$.__webglFramebuffer[re]=t.createFramebuffer()}else $.__webglFramebuffer=t.createFramebuffer();if(we)for(let re=0,le=he.length;re<le;re++){const Pe=i.get(he[re]);Pe.__webglTexture===void 0&&(Pe.__webglTexture=t.createTexture(),o.memory.textures++)}if(A.samples>0&&Xe(A)===!1){$.__webglMultisampledFramebuffer=t.createFramebuffer(),$.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,$.__webglMultisampledFramebuffer);for(let re=0;re<he.length;re++){const le=he[re];$.__webglColorRenderbuffer[re]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,$.__webglColorRenderbuffer[re]);const Pe=s.convert(le.format,le.colorSpace),Ne=s.convert(le.type),Se=S(le.internalFormat,Pe,Ne,le.normalized,le.colorSpace,A.isXRRenderTarget===!0),_e=ye(A);t.renderbufferStorageMultisample(t.RENDERBUFFER,_e,Se,A.width,A.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+re,t.RENDERBUFFER,$.__webglColorRenderbuffer[re])}t.bindRenderbuffer(t.RENDERBUFFER,null),A.depthBuffer&&($.__webglDepthRenderbuffer=t.createRenderbuffer(),Re($.__webglDepthRenderbuffer,A,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(me){n.bindTexture(t.TEXTURE_CUBE_MAP,ae.__webglTexture),te(t.TEXTURE_CUBE_MAP,M);for(let re=0;re<6;re++)if(M.mipmaps&&M.mipmaps.length>0)for(let le=0;le<M.mipmaps.length;le++)de($.__webglFramebuffer[re][le],A,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+re,le);else de($.__webglFramebuffer[re],A,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);f(M)&&m(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(we){for(let re=0,le=he.length;re<le;re++){const Pe=he[re],Ne=i.get(Pe);let Se=t.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(Se=A.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Se,Ne.__webglTexture),te(Se,Pe),de($.__webglFramebuffer,A,Pe,t.COLOR_ATTACHMENT0+re,Se,0),f(Pe)&&m(Se)}n.unbindTexture()}else{let re=t.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(re=A.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(re,ae.__webglTexture),te(re,M),M.mipmaps&&M.mipmaps.length>0)for(let le=0;le<M.mipmaps.length;le++)de($.__webglFramebuffer[le],A,M,t.COLOR_ATTACHMENT0,re,le);else de($.__webglFramebuffer,A,M,t.COLOR_ATTACHMENT0,re,0);f(M)&&m(re),n.unbindTexture()}A.depthBuffer&&Ve(A)}function ie(A){const M=A.textures;for(let $=0,ae=M.length;$<ae;$++){const he=M[$];if(f(he)){const me=v(A),we=i.get(he).__webglTexture;n.bindTexture(me,we),m(me),n.unbindTexture()}}}const ce=[],Ee=[];function I(A){if(A.samples>0){if(Xe(A)===!1){const M=A.textures,$=A.width,ae=A.height;let he=t.COLOR_BUFFER_BIT;const me=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,we=i.get(A),re=M.length>1;if(re)for(let Pe=0;Pe<M.length;Pe++)n.bindFramebuffer(t.FRAMEBUFFER,we.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Pe,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,we.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Pe,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,we.__webglMultisampledFramebuffer);const le=A.texture.mipmaps;le&&le.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,we.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,we.__webglFramebuffer);for(let Pe=0;Pe<M.length;Pe++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(he|=t.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(he|=t.STENCIL_BUFFER_BIT)),re){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,we.__webglColorRenderbuffer[Pe]);const Ne=i.get(M[Pe]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ne,0)}t.blitFramebuffer(0,0,$,ae,0,0,$,ae,he,t.NEAREST),l===!0&&(ce.length=0,Ee.length=0,ce.push(t.COLOR_ATTACHMENT0+Pe),A.depthBuffer&&A.resolveDepthBuffer===!1&&(ce.push(me),Ee.push(me),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Ee)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,ce))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),re)for(let Pe=0;Pe<M.length;Pe++){n.bindFramebuffer(t.FRAMEBUFFER,we.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Pe,t.RENDERBUFFER,we.__webglColorRenderbuffer[Pe]);const Ne=i.get(M[Pe]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,we.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Pe,t.TEXTURE_2D,Ne,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,we.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const M=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[M])}}}function ye(A){return Math.min(r.maxSamples,A.samples)}function Xe(A){const M=i.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function st(A){const M=o.render.frame;h.get(A)!==M&&(h.set(A,M),A.update())}function ge(A,M){const $=A.colorSpace,ae=A.format,he=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||$!==so&&$!==ar&&(rt.getTransfer($)===pt?(ae!==oi||he!==Un)&&je("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):lt("WebGLTextures: Unsupported texture color space:",$)),M}function ot(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=B,this.getTextureUnits=X,this.setTextureUnits=k,this.setTexture2D=N,this.setTexture2DArray=P,this.setTexture3D=T,this.setTextureCube=Z,this.rebindTextures=Fe,this.setupRenderTarget=Ae,this.updateRenderTargetMipmap=ie,this.updateMultisampleRenderTarget=I,this.setupDepthRenderbuffer=Ve,this.setupFrameBufferTexture=de,this.useMultisampledRTT=Xe,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function k2(t,e){function n(i,r=ar){let s;const o=rt.getTransfer(r);if(i===Un)return t.UNSIGNED_BYTE;if(i===cp)return t.UNSIGNED_SHORT_4_4_4_4;if(i===up)return t.UNSIGNED_SHORT_5_5_5_1;if(i===gx)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===_x)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===px)return t.BYTE;if(i===mx)return t.SHORT;if(i===pa)return t.UNSIGNED_SHORT;if(i===lp)return t.INT;if(i===bi)return t.UNSIGNED_INT;if(i===xi)return t.FLOAT;if(i===Bn)return t.HALF_FLOAT;if(i===vx)return t.ALPHA;if(i===xx)return t.RGB;if(i===oi)return t.RGBA;if(i===Wi)return t.DEPTH_COMPONENT;if(i===Vr)return t.DEPTH_STENCIL;if(i===yx)return t.RED;if(i===hp)return t.RED_INTEGER;if(i===Qr)return t.RG;if(i===dp)return t.RG_INTEGER;if(i===fp)return t.RGBA_INTEGER;if(i===Gl||i===Wl||i===jl||i===Xl)if(o===pt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Gl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Wl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===jl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Xl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Gl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Wl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===jl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Xl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Ad||i===Cd||i===Rd||i===Pd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Ad)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Cd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Rd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Pd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Ld||i===Dd||i===Nd||i===Id||i===Ud||i===yc||i===kd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Ld||i===Dd)return o===pt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Nd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Id)return s.COMPRESSED_R11_EAC;if(i===Ud)return s.COMPRESSED_SIGNED_R11_EAC;if(i===yc)return s.COMPRESSED_RG11_EAC;if(i===kd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Fd||i===Od||i===Bd||i===zd||i===Vd||i===Hd||i===Gd||i===Wd||i===jd||i===Xd||i===qd||i===$d||i===Yd||i===Kd)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Fd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Od)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Bd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===zd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Vd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Hd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Gd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Wd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===jd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Xd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===qd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===$d)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Yd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Kd)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Zd||i===Qd||i===Jd)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Zd)return o===pt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Qd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Jd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===ef||i===tf||i===Sc||i===nf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===ef)return s.COMPRESSED_RED_RGTC1_EXT;if(i===tf)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Sc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===nf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ma?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const F2=`
void main() {
