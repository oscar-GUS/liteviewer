...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wi,depthTest:!1,depthWrite:!1})}function BT(t,e,n){const i=new Float32Array(kr),r=new B(0,1,0);return new un({name:"SphericalGaussianBlur",defines:{n:kr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Kc(),fragmentShader:`
